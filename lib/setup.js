...
function metaGetPayloadForHandler(store) {
    return (eventName, requiredEvents) => {
        ...
        return ((requiredEventStreams === null || requiredEventStreams === void 0 ? void 0 : requiredEventStreams.length)
            ...
            : mainEvent$).pipe((0, operators_1.tap)((event) => {
            var _a, _b, _c;
            return ((_a = store.options.logOptions) === null || _a === void 0 ? void 0 : _a.logOn)
                && store.options.logOptions.events
                && ((_c = (_b = store.options.logOptions).logger) === null || _c === void 0 ? void 0 : _c.call(_b, `EVENT:${String(event.name)}`));
        }), (0, operators_1.map)((event) => event === null || event === void 0 ? void 0 : event.payload), (0, operators_1.withLatestFrom)(store.store$.asObservable()), (0, operators_1.shareReplay)(1));
    };
}
/**
 * Handler for reducer
