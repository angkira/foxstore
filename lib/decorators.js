...
exports.schemeGen = exports.createStore = exports.setupStoreEvents = exports.setupStoreEventsFromDecorators = exports.Store = exports.Effect = exports.Reducer = exports.Action = void 0;
...
function simplyMetaPatcher(instance) {
    return (event, writeAs, state) => (event.async ?
        ...
        .subscribe((actionPayload) => instance.patch(types_1.simplyReducer(writeAs)
...
function metaGetEntityPayload({ eventDispatcher, store$ }) {
    ...
    operators_1.mergeMap((event) => (event.async ?
        event.payload
        : rxjs_1.of(event.payload))
        .pipe(operators_1.take(1))), operators_1.withLatestFrom(store$), operators_1.shareReplay(1));
}
/**
 * Handler for reducer
 * @param instance
