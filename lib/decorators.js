...
function Store(initState, customDispatcher, eventScheme = {}) {
    return function (target = Object) {
        ...
        const f = function (...args) {
            ...
            const effects = Reflect.getMetadata(EFFECT_METAKEY, constructor)
                || [];
            const reducers = Reflect.getMetadata(REDUCER_METAKEY, constructor)
                || [];
            const actions = Reflect.getMetadata(ACTION_METAKEY, constructor)
                || [];
            ...
            exports.setupStoreEvents(metadataEventScheme)(newInstance);
            return newInstance;
        };
 ...
 */
exports.createStore = (initState, customDispatcher, options = store_1.DefaultStoreOptions, eventScheme = {}) => exports.setupStoreEvents(eventScheme)(new store_1.ProtoStore(initState, options, customDispatcher));
