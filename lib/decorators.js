...
function metaGetEntityPayload({ eventDispatcher, store$ }) {
    return (eventName, requiredEvents) => rxjs_1.combineLatest([
        ((requiredEvents === null || requiredEvents === void 0 ? void 0 : requiredEvents.length) ?
            eventDispatcher
                .listen(eventName)
                .pipe(operators_1.skipUntil(rxjs_1.zip(...requiredEvents.map(eventName => eventDispatcher.listen(eventName)))))
            : eventDispatcher
