...
const setupStoreEvents = (eventScheme = {}) => (newInstance) => {
    ...
    const payloadStreams = ramda_1.keys(eventScheme)
        ...
        const logger = (((_a = newInstance.options) === null || _a === void 0 ? void 0 : _a.logOn) && ((_c = (_b = newInstance.options) === null || _b === void 0 ? void 0 : _b.logOptions) === null || _c === void 0 ? void 0 : _c.events)
