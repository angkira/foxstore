...
class ProtoStore {
    ...
    select(entityName) {
        if (entityName) {
            ...
            return rxjs_1.pipe(operators_1.distinctUntilChanged(), operators_1.takeUntil(this.eventDispatcher.destroy$), operators_1.shareReplay(1))(this.store$.asObservable());
        }
    }
    /**
