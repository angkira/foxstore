...
class ProtoStore {
    ...
    patch(update) {
        ...
        this.options.logOn
            && ((_b = this.options.logOptions) === null || _b === void 0 ? void 0 : _b.state)
            && this.options.logger
            && this.options.logger(`${((_c = this.options) === null || _c === void 0 ? void 0 : _c.storeName) || this['constructor'].name} | State updated: `, patchedState);
        return this;
    }
    /**
