...
class ProtoStore {
    ...
    patch(update) {
        var _a, _b, _c, _d, _e;
        const patchedState = Object.assign((0, ramda_1.mergeDeepRight)(this.snapshot, update), ((_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.hashMap) === null || _b === void 0 ? void 0 : _b.on) ? this.getHashMap(update) : {});
        this.store$.next(patchedState);
        const logOptions = (_c = this.options) === null || _c === void 0 ? void 0 : _c.logOptions;
        const logString = `${((_d = this.options) === null || _d === void 0 ? void 0 : _d.storeName) || this['constructor'].name} | State updated: `;
        (logOptions === null || logOptions === void 0 ? void 0 : logOptions.logOn) &&
            (logOptions === null || logOptions === void 0 ? void 0 : logOptions.state) &&
            ((_e = logOptions === null || logOptions === void 0 ? void 0 : logOptions.logger) === null || _e === void 0 ? void 0 : _e.call(logOptions, logString, patchedState));
        return this;
    }
    /**
    ...
    dispatch(eventName, payload) {
        ...
        (logOptions === null || logOptions === void 0 ? void 0 : logOptions.logOn) && logOptions.events && ((_a = logOptions.logger) === null || _a === void 0 ? void 0 : _a.call(logOptions, eventName));
        this.eventDispatcher.dispatch(new dispatcher_1.Event(eventName, payload));
        return this;
    }
    listen(eventName) {
        return this.eventDispatcher.listen(eventName);
    }
    /**
