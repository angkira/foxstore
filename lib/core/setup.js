...
function metaGetPayloadForHandler(store) {
    return (eventName, requiredEvents) => {
        ...
        if (requiredEventsStreams === null || requiredEventsStreams === void 0 ? void 0 : requiredEventsStreams.length) {
            const requiredEvents$ = (0, rxjs_1.zip)(...requiredEventsStreams);
            const guardedEvent$ = (requiredEvents === null || requiredEvents === void 0 ? void 0 : requiredEvents.emitImmediately)
                ? requiredEvents$.pipe((0, operators_1.switchMap)(() => mainEvent$.pipe((0, operators_1.take)(1))))
                : (0, rxjs_1.zip)(requiredEvents$, mainEvent$).pipe((0, operators_1.switchMap)(() => mainEvent$.pipe((0, operators_1.skip)(1), (0, operators_1.take)(1))));
